<template>
    <base-card>
        <base-button :mode="storedResButtonMode"
            @click="changeSelectedTab('stored-resources')">Stored Resources</base-button>
        <base-button :mode="addResButtonMode"
            @click="changeSelectedTab('add-resource')">Add Resource</base-button>
    </base-card>
    <keep-alive>
